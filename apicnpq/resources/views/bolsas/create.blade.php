<x-layout title="Novo Bolsa">
<div class="container" >
    <h1>Cadastro de nova bolsa</h1>
    <p>Insira os dados abaixos para realizar o cadastro!</p>
    <form action="/bolsas/salvar" method="post">
        @csrf
        @method('POST')
        <div class="form-group">
            <div class="form-group">
                <label for="protocolo">Protocolo: </label>
                <input class="form-control" class="form-control" type="number" id="protocolo" name="protocolo">
            </div>
            <br>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" class="form-control" type="number" id="valor" name="valor">
            </div>
            <br>
            <div class="form-group">
